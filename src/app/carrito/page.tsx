...
export default function CarritoPage() {
  ...
  return (
    <main className="min-h-screen px-6 py-10">
      <h1 className="text-3xl font-bold mb-6">Alex Miguel Carrito pipeline funcionando14426</h1>

      {items.length === 0 && (
        <p className="text-lg text-slate-500">Alex Miguel Tu carrito está vacío pipeline funcionando14426.</p>
      )}
