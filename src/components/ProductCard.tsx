...
export function ProductCard({ producto }: ProductCardProps) {
  ...
  return (
    <Link href={`/producto/${producto.id}`}>
      <article className="group flex flex-col overflow-hidden rounded-2xl border bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg cursor-pointer">
        ...
        <div className="flex flex-1 flex-col gap-2 p-4">
          ...
          <div className="mt-auto flex items-center justify-between pt-2">
            ...
            <button
              ...
              onClick={(e) => e.preventDefault()} // evita navegar si solo quieres usar el botón
            >
              Agregar al carrito
            </button>
          </div>
